    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-indigo-500 animate-pulse mx-auto mb-4"></div>
          <p className="text-gray-600 font-medium">Loading your vibrant week...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="inline-flex items-center px-4 py-2 rounded-xl bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 text-white font-medium hover:from-purple-600 hover:via-pink-600 hover:to-indigo-600 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
