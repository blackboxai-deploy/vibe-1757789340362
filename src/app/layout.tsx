...
export const metadata: Metadata = {
  title: 'Vibrant Week - 7-Day Task Manager',
  description: 'A vibrant and interactive 7-day week planner with integrated to-do list functionality',
  keywords: ['todo', 'task manager', 'weekly planner', 'productivity', 'weekend planner'],
  authors: [{ name: 'Vibrant Week App' }],
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="hidden sm:block">
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-500">Stay organized, stay vibrant!</p>
                  </div>
                </div>
              </div>
            </div>
